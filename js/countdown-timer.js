!function ($) {
    ...
    Countdown.prototype.update = function () {
        ...
        this.offset = {
            ...
            hours: Math.floor((this.totalSecsLeft % (60 * 60 * 24)) / (60 * 60)),
    ...
    $.fn.countdown = function () {
        ...
        return this.each(function () {
            ...
            if (instanceNumber !== undefined) {
                ...
                // Set finalDate to 10 days from now
                var finalDate = new Date(new Date().getTime() + 10 * 24 * 60 * 60 * 1000);
                new Countdown(this, finalDate, argumentsArray[1]);
            }
        });
    };
}(window.jQuery);
